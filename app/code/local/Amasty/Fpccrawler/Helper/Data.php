        ...
        if ($queueSource['source']) {
            ...
            switch ($source) {
                ...
                case 'sitemap':
                    ...
                    $filePath = Mage::getBaseDir('base') . '/sitemap.xml';
                    if (file_exists($filePath)) {
                        $message .= 'but the sitemap is empty: ' . $filePath . '; Please fill in the sitemap file or use the Amasty XML Google Sitemap extension to do this automatically. https://amasty.com/magento-xml-google-sitemap.html?utm_source=extension&utm_medium=link&utm_campaign=xml-sitemap-from-fpc-m1';
                    } else {
