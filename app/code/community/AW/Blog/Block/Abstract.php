...
abstract class AW_Blog_Block_Abstract extends Mage_Core_Block_Template
{
	...
	{
		//return '<a class="aw-blog-read-more" href="' . $item->getAddress() . '">' . $this->__('Read More') . '</a>'; // NVNCBL COMMENTED OUT
		return '<a class="aw-blog-read-more button button-black" href="' . $item->getAddress() . '">' . $this->__('Read More') . '</a>'; // NVNCBL CUSTOM
	}
